...
import { ArrowLeft, MapPin, HandCoins, TrendingUp, ShieldCheck, Globe2, Network } from 'lucide-react'
import { OrnamentalDivider, SectionEyebrow, SiteHeader, SiteFooter } from '../components/shared'
    ...
    <div className="min-h-screen bg-goth-bg text-neutral-200">
      ...
      <main>
        <section className="mx-auto max-w-4xl px-6 py-20 sm:py-28">
          <Link
            to="/#projets"
            className="mb-10 inline-flex items-center gap-2 font-mono text-xs uppercase tracking-[0.2em] text-neutral-400 transition-colors hover:text-goth-rose"
          >
          ...
          <h1 className="text-engraved mb-6 text-center font-display text-3xl tracking-wide text-neutral-50 sm:text-5xl">
            Ma Commune <span className="text-goth-rose">Vivante</span>
          </h1>
          <p className="mx-auto max-w-2xl text-center text-base text-neutral-400 sm:text-lg">
            Un écosystème numérique souverain conçu pour reconnecter les citoyens, les
            associations et les institutions autour de la gestion durable du territoire.
          </p>
        ...
        <section className="bg-neutral-950/60 px-6 py-20">
          <div className="mx-auto max-w-3xl text-center">
            ...
            <h2 className="text-engraved mb-6 font-heading text-2xl tracking-wide text-neutral-50 sm:text-3xl">
              Une infrastructure, pas qu'une plateforme
            </h2>
            <p className="text-base leading-relaxed text-neutral-400">
              Ma Commune Vivante dépasse la simple plateforme de signalement. C'est une
              infrastructure de coordination qui transforme l'engagement individuel en action
              publique structurée. Qu'il s'agisse de restaurer la biodiversité, de gérer les
              urgences faune ou de planifier la végétalisation, l'outil offre un espace neutre
              où chaque acteur — citoyen, association ou commune — peut contribuer à la
              résilience locale sur la base de données factuelles et vérifiées.
            </p>
          </div>
        </section>
            ...
            {cycle.map((step) => (
              ...
              >
                <div className="mb-3 flex items-center justify-between">
                  <span className="font-display text-3xl text-goth-rose/40">{step.number}</span>
                  <span className="text-goth-rose">{step.icon}</span>
                </div>
        ...
        <section className="bg-neutral-950/60 px-6 py-20">
          ...
          <p className="mx-auto mb-12 max-w-2xl text-center text-sm text-neutral-500">
            Next.js (App Router), TypeScript, Supabase (PostgreSQL + PostGIS) — mis au service
            de problèmes concrets de gouvernance territoriale.
          </p>
          <div className="mx-auto grid max-w-5xl gap-6 sm:grid-cols-3">
            {challenges.map((item) => (
              <div
                ...
                className="rounded-2xl border border-goth-violet/20 bg-neutral-950/80 p-6"
              >
                <span className="mb-3 inline-flex text-goth-rose">{item.icon}</span>
        ...
        <section className="mx-auto max-w-3xl px-6 py-20 text-center">
          ...
          <p className="text-base leading-relaxed text-neutral-400">
            Pour préserver la souveraineté des données territoriales et la sécurité de
            l'architecture, le code source n'est plus en accès libre durant la phase de
            validation partenariale. Le développement suit un versioning rigoureux et une
